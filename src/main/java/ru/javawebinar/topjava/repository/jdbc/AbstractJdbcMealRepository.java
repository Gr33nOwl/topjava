...
public abstract class AbstractJdbcMealRepository<T> implements MealRepository {
    ...
    abstract T getTime(LocalDateTime localDateTime);

    @Repository
    @Profile(Profiles.POSTGRES_DB)
    public static class PostgresMealRepository extends AbstractJdbcMealRepository<LocalDateTime> {
    ...
    public static class HSQLDBMealRepository extends AbstractJdbcMealRepository<Timestamp> {
        ...
        @Override
        Timestamp getTime(LocalDateTime localDateTime) {
    ...
    public Meal save(Meal meal, int userId) {
        MapSqlParameterSource map = new MapSqlParameterSource()
                ...
                .addValue("date_time", getTime(meal.getDateTime()))
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        return jdbcTemplate.query(
                ...
                ROW_MAPPER, userId, getTime(startDateTime), getTime(endDateTime));
    }
}
